      ...
      if (this.nodeRuntimePath) {
        tools.push({
          ...
          description:
            ...
            'For security reasons, the code cannot perform file operations, modify system settings, spawn child processes, or execute external code. ' +
            'Code execution has a timeout limit, default is 5 seconds. ' +
            'Use this tool only when other tools cannot meet your requirements.',
